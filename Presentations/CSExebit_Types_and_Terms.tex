...
\begin{itemize}
  \item Final year undergraduate at IIT Madras
  \item Worked on formal methods and verification for ~1 year
  \item Currently working on neurosymbolic methods at FP Launchpad with Prof. KC Sivaramakrishnan
  \item Published a paper titled Sal : Multi Modal Verification of Replicated Data Types accepted into PaPoC 2026
\end{itemize}
\end{frame}
\begin{frame}
